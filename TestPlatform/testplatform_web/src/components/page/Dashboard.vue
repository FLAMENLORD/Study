      ...
      <el-col :span="8">
        ...
        <el-card shadow="hover" style="height:180px;">
          ...
          <el-progress
            :text-inside="true"
            :stroke-width="20"
            :percentage="statistics.fail_rate"
            status="exception"
          ></el-progress>
        </el-card>
      </el-col>
              ...
              <div class="grid-content grid-con-1">
                ...
                <div class="grid-cont-right">
                  <router-link
                    ...
                    class="grid-num"
                  >{{ statistics.projects_count }}</router-link>
                  <div>项目总数</div>
                </div>
              </div>
            </el-card>
              ...
              <div class="grid-content grid-con-2">
                ...
                <div class="grid-cont-right">
                  <router-link
                    ...
                    class="grid-num"
                  >{{ statistics.interfaces_count }}</router-link>
                  <div>接口总数</div>
                </div>
              </div>
            </el-card>
              ...
              <div class="grid-content grid-con-3">
                ...
                <div class="grid-cont-right">
                  <router-link
                    ...
                    class="grid-num"
                  >{{ statistics.testcases_count }}</router-link>
                  <div>用例总数</div>
                </div>
              </div>
            </el-card>
              ...
              <div class="grid-content grid-con-4">
                ...
                <div class="grid-cont-right">
                  <router-link
                    ...
                    class="grid-num"
                  >{{ statistics.testsuits_count }}</router-link>
                  <div>套件总数</div>
                </div>
              </div>
            </el-card>
              ...
              <div class="grid-content grid-con-1">
                ...
                <div class="grid-cont-right">
                  <router-link
                    ...
                    class="grid-num"
                  >{{ statistics.configures_count }}</router-link>
                  <div>配置总数</div>
                </div>
              </div>
            </el-card>
              ...
              <div class="grid-content grid-con-2">
                ...
                <div class="grid-cont-right">
                  <router-link
                    :to="{ name: 'envs_list' }"
                    class="grid-num"
                  >{{ statistics.envs_count }}</router-link>
                  <div>环境变量总数</div>
                </div>
              </div>
            </el-card>
              ...
              <div class="grid-content grid-con-3">
                ...
                <div class="grid-cont-right">
                  <router-link
                    ...
                    class="grid-num"
                  >{{ statistics.debug_talks_count }}</router-link>
                  <div>内置函数总数</div>
                </div>
              </div>
            </el-card>
              ...
              <div class="grid-content grid-con-4">
                ...
                <div class="grid-cont-right">
                  <router-link
                    ...
                    class="grid-num"
                  >{{ statistics.reports_count }}</router-link>
                  <div>测试报告总数</div>
                </div>
              </div>
            </el-card>
